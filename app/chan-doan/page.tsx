  ...
  return (
    <>
      <style>{`
        ...
        .cd-card { background:rgba(26,58,30,0.6); border:1px solid rgba(127,184,138,0.15); border-radius:20px; padding:24px; margin-top:20px; }
        ...
        .cd-info-box { background:rgba(13,31,15,0.6); border:1px solid rgba(127,184,138,0.12); border-radius:14px; padding:14px; }
